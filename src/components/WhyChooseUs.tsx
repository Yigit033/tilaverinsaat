        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground mt-4">
              Neden <span className="text-primary">Tilaver</span>?
            </h2>
          </div>
        </ScrollReveal>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((r, i) => (
            <ScrollReveal key={r.title} delay={i * 0.1}>
              <div className="group border border-border p-8 text-center hover:border-primary transition-all duration-500 h-full">
